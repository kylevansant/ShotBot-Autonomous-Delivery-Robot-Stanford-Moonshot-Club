...
ShotBot reached the prototype stage as a remotely controlled delivery robot capable of stair-climbing. Several additional capabilities, including LiDAR-based sensing and more advanced navigation, were explored during development but were not fully implemented within the project's scope.
